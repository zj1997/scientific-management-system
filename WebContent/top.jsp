		...
		<TABLE cellSpacing=0 cellPadding=0 width="100%" border=0>
			<TBODY>
				<TR>
					...
					<TD background=images/new_002.jpg><FONT size=5><B>科  研  管  理  系  统</B></FONT></TD>
							...
							<TBODY>
								...
								<TR>
									<TD height=35 align="right">
										当前用户：${admin}
										&nbsp;&nbsp;&nbsp;&nbsp;
										<A href="${pageContext.request.contextPath}/jsp/updatepassword.jsp" target=_top><FONT color=red>修改密码</FONT></A>
										&nbsp;&nbsp;&nbsp;&nbsp;
