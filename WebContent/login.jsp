...
<BODY>
<FORM id=form1 name=form1 action="${pageContext.request.contextPath}/loginServlet"  onsubmit="javascript:return WebForm_OnSubmit();" method=post>
            ...
            <TABLE cellSpacing=0 cellPadding=2 border=0>
              ...
              <TR>
                ...
                <TD style="HEIGHT: 28px" width=150><INPUT id=txtName 
                  style="WIDTH: 130px" name="account"></TD>
              ...
              <TR>
                ...
                <TD style="HEIGHT: 28px"><img src="${pageContext.request.contextPath}/checkimg"></TD>
              ...
              <TR>
              <h1 style="color: red">${loginerror}</h1>
              <h1 style="color: red">${checkcode}</h1>
                <TD></TD>
                <TD><INPUT id=btn 
